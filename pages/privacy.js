      ...
      <div style={{ background: 'var(--parchment)', padding: '48px 44px', minHeight: 'calc(100vh - 116px)' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ fontSize: '14px', color: 'var(--midnight)', lineHeight: 1.8 }}>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', fontWeight: 'normal', marginTop: '24px', marginBottom: '12px' }}>5. Cookies and Tracking</h2>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', fontWeight: 'normal', marginTop: '24px', marginBottom: '12px' }}>6. Your Rights</h2>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', fontWeight: 'normal', marginTop: '24px', marginBottom: '12px' }}>7. Security</h2>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', fontWeight: 'normal', marginTop: '24px', marginBottom: '12px' }}>8. Changes to This Policy</h2>
            <p>We may update this privacy policy from time to time. Changes will be posted on this page with an updated "Last updated" date.</p>

            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', fontWeight: 'normal', marginTop: '24px', marginBottom: '12px' }}>9. Contact Us</h2>
